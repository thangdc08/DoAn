	...
	public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
		return http
			...
			.authorizeExchange(auth -> auth
				...
				// Venue Onboarding & Management — Owner, Admin & Staff
				...
				.pathMatchers(HttpMethod.GET, "/venues/api/venues/my").hasAnyAuthority("SCOPE_USER", "SCOPE_OWNER", "SCOPE_ADMIN", "SCOPE_STAFF")
				.pathMatchers(HttpMethod.POST, "/venues/**").hasAnyAuthority("SCOPE_OWNER", "SCOPE_ADMIN", "SCOPE_STAFF")
				.pathMatchers(HttpMethod.PUT, "/venues/**").hasAnyAuthority("SCOPE_OWNER", "SCOPE_ADMIN", "SCOPE_STAFF")
				.pathMatchers(HttpMethod.DELETE, "/venues/**").hasAnyAuthority("SCOPE_OWNER", "SCOPE_ADMIN", "SCOPE_STAFF")
